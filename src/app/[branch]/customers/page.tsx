...
import { Search, ChevronLeft, ChevronRight, Phone, User, Calendar, ShoppingBag, X, CreditCard } from "lucide-react";
...
export default function BranchCustomerOrdersPage() {
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-dark-500 mt-1 pl-3.5 font-medium">
              View your branch's registered customers and their full order history
            </p>
          </div>
        </div>
                ...
                {paginatedCustomers.length > 0 ? (
                  ...
                  <tr>
                    <td colSpan={5} className="px-6 py-12 text-center text-dark-400 font-bold text-xs tracking-widest uppercase">
                      {loading ? "Loading customers..." : `No customer records found matching "${search}".`}
                    </td>
                  </tr>
                )}
              </tbody>
